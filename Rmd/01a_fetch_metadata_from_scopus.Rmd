...
process_queried_items_df <- function(queried_items_df, vars_to_keep = c()) {
  ...
  processed_df_final$journal_issn <- ifelse(is.null(processed_df$`prism:issn`), processed_df$`prism:eIssn`, processed_df$`prism:issn`)
...
#save to csv
write.csv(PS_2024, "PS_2024_metadata.csv")
```
