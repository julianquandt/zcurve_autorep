...
Let's fetch all publications of the journal *Psychologocial Science* in 2024.

```{r}
publications <- fetchPublications('0956-7976', '2024', '2024', clean_unpublished = FALSE)
...
# save to csv file
write.csv(publications_df, here::here("data/example_publications_xref.csv"))
```
